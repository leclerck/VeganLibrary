	...
	<div id="colorlib-page">
		...
		<aside id="colorlib-aside" role="complementary" class="js-fullheight">
			...
			<div class="colorlib-footer mb-5 py-3">
				<h1 id="colorlib-logo" class="mb-5"><a href="index.jsp"
						style="background-image: url(../images/bg_1.jpg);">Vegan<span>Library</span></a></h1>
				...
				<div class="container">
					<div class="row d-flex">
								...
								<div class="col-md-12">
									<div class="blog-entry ftco-animate d-md-flex">
										...
										<div class="text text-2 pl-md-4">
											<h3 class="mb-2"><a href="single.jsp">A Loving Heart is the Truest
													Wisdom</a></h3>
											<div class="meta-wrap">
												<p class="meta">
													<span><a href=""><i class="icon-calendar mr-2"></i>2019</a></span>
													<span><a href=""><i
																class="icon-folder-o mr-2"></i>N Stars</a></span>
													<span><a href=""><i class="icon-comment2 mr-2"></i>N Reviews</a></span>
												</p>
											</div>
											<p>ISBN: </p>
											<p>Authors: <ul>
						...
						<div class="col-xl-4 sidebar ftco-animate bg-light pt-5">
							...
							<div class="sidebar-box ftco-animate">
								<h3 class="sidebar-heading">Popular Books</h3>
								<!--1er POST-->
							...
							<div class="sidebar-box ftco-animate">
								...
								<ul class="tagcloud">
									...
									<a href="#" class="tag-cloud-link">plant-based</a>
								</ul>
							</div>
